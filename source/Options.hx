...
class BotPlay extends Option
{
	...
	private override function updateDisplay():String
		...
		{
			return "Turn Botplay on I dare you ";
		}
		else
		{
			return "You Idiot.";
...
class CutsceneFreeplay extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.cutsceneFreeplay= !FlxG.save.data.cutsceneFreeplay;
		trace('Cutscene Freeplay : ' + FlxG.save.data.cutsceneFreeplay);
		display = updateDisplay();
		return true;
	}
	
	private override function updateDisplay():String
		return "Cutscenes in Freeplay " + (FlxG.save.data.cutsceneFreeplay ? "on" : "off");
}
class CutsceneSounds extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.cutsceneSounds= !FlxG.save.data.cutsceneSounds;
		trace('Cutscene Sounds : ' + FlxG.save.data.cutsceneSounds);
		display = updateDisplay();
		return true;
	}
	
	private override function updateDisplay():String
		return "Cutscene Sounds are " + (FlxG.save.data.cutsceneSounds ? "on" : "off");
}
/*class HardMode extends Option
{
	public static var hardmodeUnlocked:Bool = false;

	public function new(desc:String)
	{
		if (FlxG.save.data.hardModeUnlocked = true)
			{
				super();
		        description = desc;
			}
		...
		if (FlxG.save.data.hardModeUnlocked = true)
			{
		        ...
		        trace('Hard Mode : ' + FlxG.save.data.hardmode);
		        display = updateDisplay();
			}
			else
			{
	...
	private override function updateDisplay():String
		if (FlxG.save.data.hardModeUnlocked = true)
		{
			return "Hard Mode Is " + (FlxG.save.data.hardmode ? "on" : "off");
		}
		else
		{

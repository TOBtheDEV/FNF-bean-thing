...
class StoryMenuState extends MusicBeatState
{
	...
	var weekNames:Array<String> = [
		"bister Meaan in friday nite funkig?!1!1!?",
	];
	...
	function updateText()
	{
		...
		foreGround = new FlxSprite(0, 0).loadGraphic(Paths.image('foreground'));
		foreGround.screenCenter(Y);

	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0)
		{
			...
			switch (PlayState.SONG.noteStyle)
			{
				case 'pixel':
					...
					if (noteType == 3)
						{
							animation.add('greenScroll', [38]);
							animation.add('redScroll', [39]);
							animation.add('blueScroll', [37]);
							animation.add('purpleScroll', [36]);
						}
					else
						{
				...
				default:
						...
						var fuckingSussy = Paths.getSparrowAtlas('NOTE_teddy');
						...
						switch(noteType)
						{
							case 2:
							{
								frames = Paths.getSparrowAtlas('NOTE_teddy');
							...
							case 3:
								{
									frames = Paths.getSparrowAtlas('NOTE_shiny');
									animation.addByPrefix('greenScroll', 'green0');
									animation.addByPrefix('redScroll', 'red0');
									animation.addByPrefix('blueScroll', 'blue0');
									animation.addByPrefix('purpleScroll', 'purple0');
